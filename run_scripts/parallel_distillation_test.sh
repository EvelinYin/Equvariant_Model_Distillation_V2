...
CUDA_VISIBLE_DEVICES=0 python main.py \
  ...
  student_train.student_ckpt_path=/home/yin178/Equvariant_Model_Distillation_V2/outputs/Rot90Groupcifar100/student/equ_vit/parallel_distillation/192_h3_parallel_zero_init_ViT/checkpoints/best-v1.ckpt \
  ...
  logging.wandb_name="test_rot90_192_h3_parallel_distillation_zero_init"
  # student_model.vit_config.group_attn_channel_pooling=true
