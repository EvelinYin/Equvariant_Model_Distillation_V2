...
CUDA_VISIBLE_DEVICES=0,1,3,4 python main.py \
  ...
  logging.wandb_name="rot45_avgPos_avgpool_192_h3_parallel_zero_init_ViT" \
  student_train.student_ckpt_path="./outputs/CIFAR100/pretrained_ViT/student/initialization/rot45/half_channel/192_zero_init_uniform_selection.ckpt"
