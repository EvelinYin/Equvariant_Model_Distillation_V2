...
CUDA_VISIBLE_DEVICES=0 python main.py \
  ...
  teacher_train.teacher_ckpt_path=/home/yin178/Equvariant_Model_Distillation_V2/outputs/cifar100/teacher/pretrained_ViT/non_equ_train_on_GT/canonicalizer/checkpoints/best-v4.ckpt \
  precision=64 \
  data.num_workers=0 \
