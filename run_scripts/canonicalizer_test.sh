...
CUDA_VISIBLE_DEVICES=0 python main.py \
  ...
  teacher_train.teacher_ckpt_path=/home/yin178/Equvariant_Model_Distillation_V2/outputs/Rot90Group/cifar100/teacher/pretrained_ViT/non_equ_train_on_GT/rot90_canonicalizer_equ_layers/checkpoints/best.ckpt \
  precision=64 \
  data.num_workers=0 \
